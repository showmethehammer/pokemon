...
import npc.Gray_Grass_Npc;
import npc.PokemonCenter;
import npc.User;
import thread.BGM;
import userset.User_Set;

public class Gray_Grass {
    public Gray_Grass() {
    }

    public void Gray_Grass(User user) {
        Random rd = new Random();
        new PokemonCenter();
        User_Set user_set = new User_Set();
        String map_name = "현재위치: 회색초원";
        ...
        while(true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    switch (rd.nextInt(3)) {
                        case 0:
                            bug.Bug(1 + rd.nextInt(8));
                            mon = bug;
                            break;
                        case 1:
                            flight.Flight(1 + rd.nextInt(8));
                            mon = flight;
                            break;
                        case 2:
                            grass.Grass(1 + rd.nextInt(8));
                            mon = grass;
                    }
                ...
                case 2:
                    ...
                    Gray_Grass_Npc you = new Gray_Grass_Npc();
            ...
            if (choice == 4) {
                ...
                System.out.println("1.태초마을     2.회색씨티     3.나가기   4.게임종료");
