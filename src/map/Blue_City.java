...
import npc.Blue_City_Boss;
import npc.PokemonCenter;
import npc.User;
import thread.BGM;
import userset.User_Set;

public class Blue_City {
    public Blue_City() {
    }

    public void Blue_City(User user) {
        ...
        while(true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    Blue_City_Boss you = new Blue_City_Boss();
                    you.Blue_City_Boss();
                    fighting_boss.Fighting_Boss(user, you, blue_badge);
                    break;
                case 4:
            ...
            if (choice == 5) {
                ...
                System.out.println("1.수련계곡    2.태화강     3.붉은화산   4.나가기   5.게임종료");
