...
public class Flight extends Pokemon {
    public Flight() {
    }

    public void Flight(int level) {
        super.type_cts = 5;
        super.type_name = "비행";
        super.mons_name[0] = "구구";
        super.mons_name[1] = "피죤";
        super.mons_name[2] = "피죤투";
